...
app_install_node()
{
    ...
    git clone http://github.com/PhilConee/Istrium.git "$SIDECHAIN_PATH"
    cd "$SIDECHAIN_PATH"
    ...
    success "Chain Installed!"

    cd
    sudo apt-get install npm
    sudo npm install -g n
    sudo n 6.9.2
    git clone https://github.com/Philconee/Istrium-desktop
    cd Istrium-desktop
    npm install

    success "Wallet Installed!"
}
